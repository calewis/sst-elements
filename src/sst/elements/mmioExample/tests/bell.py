...
#       "executable" : os.getenv("VANADIS_EXE", "./tests/stream-mini-musl"),
       "executable" : os.getenv("VANADIS_EXE", "./a.out"),
       "app.env_count" : 2,
...
bell = sst.Component("bell", "bell.Bell")
iface_bell = bell.setSubComponent("iface", "memHierarchy.standardInterface")
nic_bell = iface_bell.setSubComponent("memlink", "memHierarchy.MemNIC")
nic_bell.addParams({
    "group": 3, 
    "sources": [1], 
    "destinations": [2],
...
link_bell_2_rtr = sst.Link("link_bell_2_rtr")
link_bell_2_rtr.connect( (comp_chiprtr, "port2", "1ns"), (nic_bell, "port", "1ns") )
